...
u-blox NINA-B30x Bluetooth 5.4 module, based on the Nordic Semiconductor
...
.. figure:: img/application_board_3_0.png
     :align: center
     :alt: Application-Board-3.0

     Application Board 3.0 (Credit: bosch.sensortec.com)


Hardware
********

The NINA-B30x on the Bosch Application Board 3.0 contains an internal high-frequency
